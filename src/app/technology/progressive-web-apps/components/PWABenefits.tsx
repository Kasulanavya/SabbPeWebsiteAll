...
const benefits = [
  {
    ...
    metric: "90%",
    description: "Less space than traditional apps"
  },
  {
    title: "Load Speed",
    metric: "<1s",
    description: "Instant page loading"
  },
  {
    title: "User Engagement",
    metric: "3x",
    description: "Higher than mobile websites"
  },
  {
    title: "Install Rate",
    metric: "50%",
    description: "Users add to home screen"
  }
];
